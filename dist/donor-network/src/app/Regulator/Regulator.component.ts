...
export class RegulatorComponent implements OnInit {
  ...
  regulatorName = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.donation.network.Regulator',
      'regulatorID': this.regulatorID.value,
      'regulatorName': this.regulatorName.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.regulatorName) {
        formObject.regulatorName = result.regulatorName;
      } else {
        formObject.regulatorName = null;
      }
